...
function LandingView({ onStartProject }) {
  return (
    <>
...
<div className="flex flex-col items-center">
<span className="text-[9px] text-on-surface-variant uppercase font-bold tracking-tighter">Key</span>
<span>C# Min</span>
</div>
...
<span className="text-lg leading-none">00:42:15:08</span>
</div>
<div className="flex flex-col items-center">
...
<span className="text-zinc-600 font-mono text-xs uppercase uppercase">No Active Tracks</span>
</div>
</div>
</section>
...
<span className="text-[9px] font-bold uppercase text-zinc-600 mb-2">Processing Node</span>
<div className="bg-surface-container px-3 py-2 border-l-2 border-zinc-700 flex items-center justify-between opacity-50">
<span className="text-[10px] font-bold uppercase">Melodic Extraction</span>
<span className="material-symbols-outlined text-xs">pending</span>
</div>
<div className="bg-surface-container px-3 py-2 border-l-2 border-zinc-700 flex items-center justify-between opacity-50">
<span className="text-[10px] font-bold uppercase">Spectral Harmony</span>
<span className="material-symbols-outlined text-xs">pending</span>
</div>
</div>
</div>
<div className="mt-auto">
<button className="w-full bg-surface-container-highest text-zinc-500 font-bold uppercase py-3 text-[11px] tracking-widest transition-all" disabled>Generate Pattern</button>
</div>
</aside>
</main>
              ...
              <div className="lg:col-span-5 space-y-8">
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <input className="w-full bg-surface-container-highest border-0 border-b border-outline-variant/20 focus:ring-0 focus:border-primary text-primary monospaced text-sm px-0 py-2 transition-all" type="text" defaultValue="SESSION_2023_X4"/>
                  </div>
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    <div className="space-y-2">
                      ...
                      <div className="flex items-center gap-2 bg-surface-container-highest p-1 max-w-[50%]">
                        <input className="w-full bg-transparent border-0 focus:ring-0 text-primary monospaced text-lg font-bold p-1" type="number" defaultValue="128"/>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  {templates.map((tpl) => {
                    ...
                    return (
                      <div
                        ...
                        className={\group relative aspect-[4/3] bg-surface-container p-4 flex flex-col justify-between cursor-pointer transition-all \\}
                      >
                        <div className={\bsolute inset-0 transition-opacity \\}>
                          <img alt={tpl.id} className="w-full h-full object-cover" src={tpl.img} />
                        </div>
                        <div className="relative z-10 flex justify-between items-start">
                          <span className={\material-symbols-outlined \ transition-colors\} style={{fontVariationSettings: isSelected ? "'FILL' 1" : ""}}>{tpl.icon}</span>
                          {isSelected && (
                            <span className="bg-primary text-on-primary text-[8px] font-bold px-1.5 py-0.5 uppercase tracking-tighter">Selected</span>
                          )}
                        </div>
                        <div className="relative z-10">
                          <h3 className={\ont-bold text-sm uppercase mb-1 transition-colors \\}>{tpl.id}</h3>
                          <p className="text-[9px] text-zinc-500 uppercase tracking-wider">{tpl.desc}</p>
                        </div>
                      </div>
                    );
                  })}
...
fs.writeFileSync('src/App.tsx', generateApp());
